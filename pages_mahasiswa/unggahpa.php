...
$nrp = $_POST['nrp'];
$jenis_file = $_POST['sr'];
$tempat = $_POST['tempat_pa'];
$judul_pa = $_POST['ta'];
$pembimbing1 = $_POST['ds1'];
$pembimbing2 = $_POST['ds2'];
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="keterangan" style="display: none;">
                              <div class="card-header pb-0 p-3">
                                  <div class="row">
                                      <div class="mb-3">
                                          <label  id="label-keterangan"for="formFile" class="form-label">Tempat Pengerjaan Proyek Akhir</label>
                                          <input name="tempat_pa" class="form-control" type="text" aria-label="default input example" >
                                      </div>
                                  </div>
                              </div>
                            </div>
        ...
        $('#jenis_surat').on('change',function () {
          // surat magang
            if($('#jenis_surat').val() == 'Laporan PA') {
                ...
                $('.unduhhima').hide();
                $('.keterangan').show();
                $('#label-keterangan').text("Tempat Pengerjakan Proyek Akhir");
                $('.judulTA').show();
                $('.tingkat').hide();
                $('.tanggalHIMA').hide();
                $('.dosen').show();
