                  ...
                  <li class="nav-item dropdown pe-3 pt-3 d-flex text-right ps-4">
                    ...
                    <ul style = "height:160px" class="dropdown-menu dropdown-menu-end pt-2  px-0 py-3 me-sm-n1 " aria-labelledby="dropdownMenuButton">
                      ...
                      <li>
                        ...
                        <li>
                          <a class="dropdown-item border-radius-md" href="nilaiakhir.php">
                            <div class="d-flex py-1">
                              <div class="my-auto">
                                <h6 class="text-sm font-weight-normal mb-1">
                  ...
                  <table class="table align-items-center mb-0">
                    <thead>
                      ...
                      <tr>
                        ...
                        <th class="text-center">Catatan Hasil Seminar Proposal</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr>
                      ...
                      $user=$_SESSION['user'];
                      $no = 1;
                      $query = mysqli_query($koneksi, "SELECT * FROM nilai_seminar WHERE nama='$user' AND tampil_nilai='1'");
