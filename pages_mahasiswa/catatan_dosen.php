          ...
          <div class="card mb-4">
            <div class="card-header pb-0 p-3">
              <div class="row">
                <div class="col-6 d-flex align-items-center">
                  <h6 class="mb-0">File Bimbingan</h6>
                </div>
              </div>
            </div>
            ...
            <div class="card-body px-0 pt-0 pb-2">
                    ...
                    <div class="row">
                      <div class="mb-3">
                          <div class="row">
                            ...
                            include "../_database/config.php";
                            $id=$_GET['file'];
                            $query = mysqli_query($koneksi, "SELECT * FROM proses_bimbingan WHERE `file`='$id'");
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                              ...
                              <label name="jenis_eval" class="form-control" aria-label="default input example"><?php echo $row['dosbing']?></label>
                            </div>
                            <div class="form-group col-md-6">
                              <!-- Keterangan Tambahan -->
                              <label for="formFile" class="form-label">Keterangan</label>
                              <label name="judul_pa" class="form-control" aria-label="default input example"><?php echo $row['keterangan']?></label>
                            </div>
                        </div>
                        <div class="row">
                        <!-- file surat -->
                        ...
                        <div class="form-group">
                            <label for="exampleFormControlTextarea1">Catatan dari Dosen</label>
                            <textarea class="form-control" id="exampleFormControlTextarea1" rows="3"><?php echo $row['catatan'] ?></textarea>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div class = "mx-4">
                ...
                <a class="btn btn-primary" href="../pages_mahasiswa/file_dosbing.php?nrp=<?php echo $id ?>" role="button">OK</a>
                <?php }?>
              </form>
              </div>
            </div>
